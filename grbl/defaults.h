...
#ifdef CPU_MAP_2560_ULTIMAKER_BOARD
  #define DEFAULT_X_STEPS_PER_MM 78.7402
  #define DEFAULT_Y_STEPS_PER_MM 78.7402
  #define DEFAULT_Z_STEPS_PER_MM 200.0*8/3
  #define DEFAULT_X_MAX_RATE 9000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 9000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 900.0 // mm/min
  #define DEFAULT_X_ACCELERATION (1000.0*60*60)
  #define DEFAULT_Y_ACCELERATION (1000.0*60*60)
  #define DEFAULT_Z_ACCELERATION (1000.0*60*60)
  #define DEFAULT_X_MAX_TRAVEL 200.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 200.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 200.0 // mm
  #define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
